...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/enterprise-pulsar-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12412&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/enterprise-pulsar-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `enterprise-pulsar` can be installed with:

```
conda install enterprise-pulsar
```

It is possible to list all of the versions of `enterprise-pulsar` available on your platform with:
